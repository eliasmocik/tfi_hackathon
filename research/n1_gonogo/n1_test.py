"""Usage: python n1_test.py <hour step> [pst]
...
sys.path.insert(0, "../participant-kit")  # run from research/n1_gonogo/
import flowmath

STEP = int(sys.argv[1]) if len(sys.argv) > 1 else 3
PST = len(sys.argv) > 2 and sys.argv[2] == "pst"
UP = "../data/synth_out/TYTFS2024_WP2033_V35_synthetic_2030_seed42_"

n = pypsa.Network("../participant-kit/networks/WP2033_all-island.nc")
...
F.to_pickle("flows_unconstrained_pst.pkl" if PST else "flows_unconstrained.pkl")
